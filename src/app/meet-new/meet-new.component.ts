...
@Component({
  selector: 'app-meet-new',
  templateUrl: './meet-new.component.html',
  styleUrls: ['./meet-new.component.scss']
})
export class MeetNewComponent implements OnInit {
  ...
  playVideo(obj) {
    ...
    name.innerHTML = `<span class="set-username-new">${userName}</span>`;
